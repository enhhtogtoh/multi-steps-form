export const Contact = () => {
  return (
    <div id="contact" className="w-full h-[560] flex items-center">
      <div
        id="container"
      ...
      >
        ...
        >
          ...
          <div id="subtitle" className="w-full h-[56] flex justify-center">
            <p className="w-[576] h-[56] text-gray-600 text-xl text-center ">
        ...
        <div
          id="main-container"
          className="w-[436] h-[104] flex flex-col gap-4 items-center"
        >
          <div id="mail" className="flex h-[44] gap-5 items-center">
            <img src="./mail.png" alt="mail" />
            <p className=" text-4xl text-gray-900 font-semibold">
              tok@pinecone.mn
            </p>
            <img src="./duplicate.png" alt="duplicate" className="p-[6]" />
          </div>
        ...
        <div id="footer-container" className=" h-[68] flex gap-16">
